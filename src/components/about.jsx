            ...
            <div className="profile-card">
              <div className="profile-header">
                <div className="profile-image">
                  <img
                    src="/assets/images/person/about.jpeg"
                    alt="Profile Image"
                    className="img-fluid"
                  />
                </div>
              ...
              <div className="profile-content">
                <h3>Mahtab Ansari</h3>
                <p className="profession">Front-end Web Developer</p>
          ...
          <div className="col-lg-7" data-aos="fade-left" data-aos-delay="300">
            <div className="about-content">
              ...
              <div className="description">
                <p>
                  Front-end Web Developer with nearly 5 years of experience in the banking sector,
                  delivering large-scale projects such as internet and mobile banking.
                  Skilled in building high-traffic financial applications using React.js and Next.js, with a strong focus on UX, performance optimization, and design systems.
                  Experienced in Agile collaboration and delivering fast, reliable solutions within cross-functional teams.
                </p>
              </div>
              ...
              <div className="cta-section">
                <a href="/mahtabAnsari-frontendDeveloper-resume.pdf" target="_blank" className="btn btn-primary">
